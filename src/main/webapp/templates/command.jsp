			...
			<div class="headerHolder container pt-lg-5 pb-lg-7 py-4">
				<div class="row">
					<div class="col-6 col-sm-2">
						<!-- mainLogo -->
						<div class="logo">
							<a href="home.jsp"><img src="images/logo.png" alt="Botanical" class="img-fluid"></a>
						</div>
					</div>
									...
									<ul class="navbar-nav mx-auto text-uppercase d-inline-block">
										<li class="nav-item dropdown">
											...
											<ul class="list-unstyled text-capitalize dropdown-menu mt-0 py-0">
												<li class="d-block mx-0"><a href="home.jsp">Home 1</a></li>
										...
										<li class="nav-item active dropdown">
											...
											<ul class="list-unstyled text-capitalize dropdown-menu mt-0 py-0">
												<li class="d-block mx-0"><a href="commandes.html">Cart Page</a></li>
											</ul>
										</li>
										<li class="nav-item">
					...
					<div class="row">
						<div class="col-12 pt-lg-23 pt-md-15 pt-sm-10 pt-6 text-center">
							...
							<ul class="list-unstyled breadCrumbs d-flex justify-content-center">
								<li class="mr-sm-2 mr-1"><a href="home.jsp">Home</a></li>
								<li class="mr-sm-2 mr-1">/</li>
								<li class="mr-sm-2 mr-1"><a href="shop.jsp">Shop</a></li>
								<li class="mr-sm-2 mr-1">/</li>
				...
				<div class="row">
					...
					<!-- cartTable -->
						<table class="table cartTable">
							...
							<tbody>
							<form name="cart" action="/visionarycrofting/client/passer_commande/1" method="post" modelattribute="commandeList" class="col-12 table-responsive mb-xl-22 mb-lg-20 mb-md-16 mb-10">

							<%--							<form action="" method="post" >--%>
								<c:forEach items="${products}" var="product">
								<tr class="align-items-center product-item">
									<td class="d-none">${product.productReference}</td>
									<td class="d-flex align-items-center border-top-0 border-bottom px-0 py-6">
										<div class="imgHolder">
											<img src="/../static/images/img03.jpg" alt="image description" class="img-fluid">
										</div>
										<span class="title pl-2"><a href="/visionarycrofting/product/get/${product.id}">${product.name}</a></span>
									</td>
									<td class="fwEbold border-top-0 border-bottom px-0 py-6">${product.unitaryPrice} DH</td>
<%--									<td class="border-top-0 border-bottom px-0 py-6">10</td>--%>
									<td class="border-top-0 border-bottom px-0 py-6"><input name="quantity" type="number" placeholder="1" value=1 min="0"></td>
									<td class="fwEbold border-top-0 border-bottom px-0 py-6">${product.unitaryPrice} DH<a href="javascript:void(0);" class="fas fa-times float-right"></a></td>
								</tr>
								...
								<div class="col-12 col-md-6">
									...
									<input type="submit" onclick="createForm()" value="Proceed to checkout"class="btn btnTheme w-100 fwEbold text-center text-white md-round py-3 px-4 py-md-3 px-md-4">
								</div>
							</form>
							</tbody>
						</table>
	...
	<script>
		...
		function createForm(event) {
			...
			productItems.forEach(product => {
				console.log(product.children[0].innerText + "," + product.children[3].children[0].children[0].value);
				productListForm += product.children[0].innerText + "," + product.children[3].children[0].children[0].value + "/";
			});
