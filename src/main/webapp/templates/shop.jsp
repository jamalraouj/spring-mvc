					...
					<div class="row">
						<div class="col-12 pt-lg-23 pt-md-15 pt-sm-10 pt-6 text-center">
							...
							<ul class="list-unstyled breadCrumbs d-flex justify-content-center">
								<li class="mr-2"><a href="home.jsp">Home</a></li>
								<li class="mr-2">/</li>
							...
							<section class="widget mb-9">
								...
								<ul class="list-unstyled recentListHolder mb-0 overflow-hidden">
									<li class="mb-6 d-flex flex-nowrap">
										<div class="alignleft">
											<a href="shopdetail.jsp"><img src="http://placehold.it/70x80" alt="image description" class="img-fluid"></a>
										</div>
										<div class="description-wrap pl-1">
											<h4 class="headingVII mb-1"><a href="shopdetail.jsp">Vitamin C face wash</a></h4>
									...
									<li class="mb-6 d-flex flex-nowrap">
										...
										<div class="description-wrap pl-1">
											<h4 class="headingVII mb-1"><a href="shopdetail.jsp">Organic vegetables</a></h4>
											<strong class="price fwEbold d-block;">21.00 $</strong>
										</div>
									</li>
									<li class="mb-6 d-flex flex-nowrap">
										...
										<div class="description-wrap pl-1">
											<h4 class="headingVII mb-1"><a href="shopdetail.jsp">Organic cabbage</a></h4>
											<strong class="price fwEbold d-block;">21.00 $</strong>
										</div>
									</li>
									<li class="mb-6 d-flex flex-nowrap">
