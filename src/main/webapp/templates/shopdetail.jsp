				...
				<div class="row">
					<div class="col-12 pt-lg-23 pt-md-15 pt-sm-10 pt-6 text-center">
						...
						<ul class="list-unstyled breadCrumbs d-flex justify-content-center">
							...
							<li class="mr-2">/</li>
							<li class="mr-2"><a href="shop.jsp">Shop</a></li>
							<li class="mr-2">/</li>
		...
		<div class="twoColumns container pt-xl-23 pb-xl-20 pt-lg-20 pb-lg-20 py-md-16 py-10">
			<div class="row mb-6">
				...
				<div class="col-12 col-lg-6 order-lg-3">
					<!-- productTextHolder -->
					<form:form action="/visionarycrofting/client/addproducttocart/1/${product.productReference}" method="post"  class="productTextHolder overflow-hidden">
						...
						<strong class="price d-block mb-5 text-green">${product.unitaryPrice} DH</strong>
						<p class="mb-5">${product.description}. Vestibulum imperdiet nibh. Lorem ullamcorper volutpat. Vestibulum lacinia risus.</p>
						<ul class="list-unstyled productInfoDetail mb-5 overflow-hidden">
							<li class="mb-2">Product Code: <span>${product.productReference}</span></li>
							<li class="mb-2">Quantity: <span>${product.quantity} Items</span></li>
							<li class="mb-2">Shipping tax: <span>47 DH</span></li>
						</ul>
...
<%--						</ul>--%>
						...
						<div class="holder overflow-hidden d-flex flex-wrap mb-6">
							...
							<input hidden type="text" name="ref" value="${product.productReference}">
						<input type="submit" value="Add Cart"  class="btn btnTheme btnShop fwEbold text-white md-round py-3 px-4 py-md-3 px-md-4" value="Add To Cart">
						</div>
