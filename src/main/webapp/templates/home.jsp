							...
							<div class="collapse navbar-collapse" id="navbarNav">
								<ul class="navbar-nav mx-auto text-uppercase d-inline-block">
									...
									<li class="nav-item dropdown">
										...
										<ul class="list-unstyled text-capitalize border-right border-bottom border-left dropdown-menu mt-0 py-0">
											<li class="d-block mx-0"><a href="shop.jsp">Shop Left Sidebar</a></li>
											<li class="d-block mx-0"><a href="shopdetail.jsp">Single Product</a></li>
										</ul>
									</li>
									<li class="nav-item">
									...
									<li class="nav-item dropdown">
										...
										<ul class="list-unstyled text-capitalize border-right border-bottom border-left dropdown-menu mt-0 py-0">
											<li class="d-block mx-0"><a href="command.jsp">Cart Page</a></li>
										</ul>
									</li>
									<li class="nav-item">
...
<%--							style="background-image: url(images/b-bg.jpg);"--%>
								...
								<div class="row">
									<div class="col-12 col-xl-7">
										<div class="txtwrap pr-lg-10">
											...
											<a href="shop.jsp" class="btn btnTheme btnShop fwEbold text-white md-round py-md-3 px-md-4 py-2 px-3">Shop Now <i class="fas fa-arrow-right ml-2"></i></a>
										</div>
									</div>
									<div class="imgHolder">
					...
					<div>
						<div class="align w-100 d-flex align-items-center bgCover" >
<%--&lt;%&ndash;							<!-- holder -->&ndash;%&gt;style="background-image: url(images/b-bg2.jpg);"--%>
							<div class="container position-relative holder pt-xl-10 pt-0">
								<!-- py-12 pt-lg-30 pb-lg-25 -->
								<div class="row">
									<div class="col-12 col-xl-7">
										<div class="txtwrap pr-lg-10">
											...
											<a href="shop.jsp" class="btn btnTheme btnShop fwEbold text-white md-round py-2 px-3 py-md-3 px-md-4">Shop Now <i class="fas fa-arrow-right ml-2"></i></a>
										</div>
									</div>
									<div class="imgHolder">
			...
			<section class="featureSec container-fluid overflow-hidden pt-xl-12 pt-lg-10 pt-md-80 pt-5 pb-xl-10 pb-lg-4 pb-md-2 px-xl-14 px-lg-7">
				...
				<form:form method="get" action="/visionarycrofting/product/filter/">
					<select name="filter">
						<option>name</option>
				...
				<div class="col-12 p-0 overflow-hidden d-flex flex-wrap">
					...
					<div class="featureCol px-3 mb-6">
						<div class="border">
							<div class="imgHolder position-relative w-100 overflow-hidden">
    							<img src="/../static/images/img03.jpg" alt="image description" class="img-fluid w-100">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2" > <a href="/visionarycrofting/product/get/${product.id}" >${product.name} </a></span>
								<span class="price d-block fwEbold">${product.unitaryPrice} DH</span>
							</div>
						</div>
					</div>
						</c:forEach>
					...
					<div class="featureCol px-3 position-relative mb-6">
						<div class="border">
							<div class="imgHolder position-relative w-100 overflow-hidden">
								<img src="/../static/images/img04.jpg" alt="image description" class="img-fluid w-100">
								<ul class="list-unstyled postHoverLinskList d-flex justify-content-center m-0">
									<li class="mr-2 overflow-hidden"><a href="javascript:void(0);" class="icon-heart d-block"></a></li>
									<li class="mr-2 overflow-hidden"><a href="javascript:void(0);" class="icon-cart d-block"></a></li>
									<li class="mr-2 overflow-hidden"><a href="javascript:void(0);" class="icon-eye d-block"></a></li>
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="shopdetail.jsp">Neque Porro Quisquamest</a></span>
					...
					<div class="featureCol px-3 mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2" ><a href="shopdetail.jsp">Pellentesque aliquet</a></span>
					...
					<div class="featureCol px-3 position-relative mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="shopdetail.jsp">Aspetur Autodit Autfugit</a></span>
					...
					<div class="featureCol px-3 mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="shopdetail.jsp">Sit voluptatem</a></span>
					...
					<div class="featureCol position-relative px-3 mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="shopdetail.jsp">Sint Incidunt Utlabore</a></span>
					...
					<div class="featureCol px-3 mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="shopdetail.jsp">Aliquam Quaerat Voluptem</a></span>
					...
					<div class="featureCol position-relative px-3 mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="shopdetail.jsp">Neque Porro Quisquam</a></span>
					...
					<div class="featureCol position-relative px-3 mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="shopdetail.jsp">Aliquam Quaerat Voluptatem</a></span>
			...
			<div class="productOfferSec container overflow-hidden py-xl-12 py-lg-10 py-md-8 py-5">
				<div class="row">
					<div class="col-12 col-sm-6 mb-sm-0 mb-2">
						<a href="shop.jsp" class="w-100"><img src="http://placehold.it/570x350" alt="image description" class="img-fluid"></a>
					</div>
